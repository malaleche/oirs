...
<?php
    echo $this->Form->create('BuscarUsuario', array('url' => array('controller' => 'users', 'action' => 'buscadoruser')));
    echo $this->Form->input('nom_usuario', array('type' => 'text', 'label' => 'Nombre de Usuario'));
...
<div class="wrapper_search">
	...
	echo $this->Html->div('input_search',$this->Form->input('term', array('label'=>false,'value'=>$term,'type'=>'text','id'=>'buscar')));
	echo $this->Form->button('Buscar', array('class'=>'button blue', 'type'=>'submit'));
	?>
</div>﻿
